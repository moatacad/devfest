...
class Donation(db.Model):
    ...
    donate_dateupdated=db.Column(db.DateTime())
   
    #set relationships
    donatedby = db.relationship("User", backref="donordeets")
    
    #once you do the above, go and run migration within devfest virtual environment
...
class User(db.Model):  
    ...
    user_password=db.Column(db.String(250),nullable=True)
...
class Breakout(db.Model):
    ...
    regdeets = db.relationship("UserRegistration", backref="breakdeets")